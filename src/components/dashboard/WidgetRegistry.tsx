...
export const WIDGET_REGISTRY: WidgetDefinition[] = [
  ...
  },
  {
    ...
    configOptions: [
      ...
      { key: 'showVisualizer', label: 'Audio Visualizer', defaultValue: false },
      { key: 'showLUFS', label: 'LUFS Meter', defaultValue: false },
      { key: 'showDBFS', label: 'dBFS Peak Meter', defaultValue: false },
      { key: 'showKeyFinder', label: 'Off-Key Finder', defaultValue: false },
      { key: 'showStemSeparation', label: 'Stem Separation', defaultValue: false },
