...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'howItWorks.noSignup': 'Three steps. No sign-up needed. Just your music.',
    'howItWorks.step1.title': 'Drop Your Link',
    'howItWorks.step1.fullTitle': 'Upload a File or Drop Your Link',
    'howItWorks.step1.desc': 'Paste a Spotify, SoundCloud, or any music link',
    'howItWorks.step1.fullDesc': 'Upload any file up to 100 MB or just drop a link to it — Spotify, SoundCloud, YouTube, anything.',
    'howItWorks.step2.title': 'Join the Queue',
    'howItWorks.step2.fullDesc': 'Your track enters the live queue. The streamer plays it on stream.',
    'howItWorks.step2.desc': 'Submit free or pay to skip ahead',
    'howItWorks.step3.title': 'Get Reviewed',
    'howItWorks.step3.fullTitle': 'Get Reviewed Live',
    'howItWorks.step3.desc': 'Watch your song get played live on stream',
    'howItWorks.step3.fullDesc': 'Watch in real-time as the streamer listens and gives feedback.',
    'howItWorks.tip.psst': 'Psst…',
    'howItWorks.tip.secret': 'wanna know a secret?',
    'howItWorks.tip.boostTitle': 'Boost Your Spot',
    'howItWorks.tip.boostDesc': 'Pay small fee to skip the queue and support your favorite creator!',
    'howItWorks.tip.boostNow': 'Boost Now',
    'howItWorks.tip.discountCode': 'Your 5% discount code:',
    'howItWorks.cta': 'Find a Streamer & Submit',
    ...
    'form.priority': 'VIP Review',
    'form.priorityTitle': 'Skip the Line - VIP Submission',
    'form.priorityDesc': 'Get your song reviewed faster by bidding for VIP placement. Higher bids = higher position!',
    'form.signInForPriority': 'Sign in to use VIP submissions',
    ...
    'submission.messageLabel': 'Message',
    ...
    'pageSettings.tab.profile': 'Profile',
    'pageSettings.tab.form': 'Form',
    'pageSettings.tab.content': 'Content',
    'pageSettings.tab.pricing': 'Pricing',
    'pageSettings.tab.design': 'Design',
    'pageSettings.tab.language': 'Language',
    'pageSettings.tab.presets': 'Preset',
    'pageSettings.tab.stream': 'Stream',
    'pageSettings.profile.title': 'Basic Information',
    'pageSettings.profile.desc': 'Your public streamer profile information.',
    'pageSettings.profile.displayName': 'Display Name',
    'pageSettings.profile.displayNamePlaceholder': 'Your streamer name',
    'pageSettings.profile.profileUrl': 'Profile URL',
    'pageSettings.profile.bio': 'Bio',
    'pageSettings.profile.bioPlaceholder': 'Tell viewers about yourself...',
    'pageSettings.profile.images': 'Images',
    ...
    // Section Visibility
    'pageSettings.sectionVisibility.title': 'Section Visibility',
    'pageSettings.sectionVisibility.desc': 'Choose which sections are visible on your submit page.',
    'pageSettings.sectionVisibility.howItWorks': 'How It Works',
    'pageSettings.sectionVisibility.howItWorksDesc': 'Step-by-step guide for submitters',
    'pageSettings.sectionVisibility.topSongs': 'Top Songs Pedestal',
    'pageSettings.sectionVisibility.topSongsDesc': 'Showcase your top 3 favorite submissions',
    'pageSettings.sectionVisibility.publicQueue': 'Public Waiting List',
    'pageSettings.sectionVisibility.publicQueueDesc': 'Show pending submissions queue publicly',
    'pageSettings.sectionVisibility.streamEmbed': 'Stream Embed',
    'pageSettings.sectionVisibility.streamEmbedDesc': 'Show your live stream embed on the page',

    // Image Upload
    'imageUpload.avatar': 'Avatar',
    'imageUpload.banner': 'Banner',
    'imageUpload.avatarHelp': 'Square image (max 2MB)',
    'imageUpload.bannerHelp': 'Wide image (max 6MB)',
    'imageUpload.upload': 'Upload',
    'imageUpload.remove': 'Remove',
    'imageUpload.uploaded': 'Image uploaded',
    'imageUpload.uploadedDesc': 'Click Save Changes to make it live.',
    'imageUpload.failed': 'Upload failed',
    'imageUpload.failedDesc': 'Please try again.',
    'imageUpload.clickBanner': 'Click to upload banner',
    'imageUpload.uploading': 'Uploading...',

    // Referral / Discount Codes
    'referral.title': 'Discount Codes',
    'referral.thisMonth': 'codes this month',
    'referral.available': 'available',
    'referral.used': 'used',
    'referral.generate': 'Generate',
    'referral.generateCount': 'Generate {count} Codes',
    'referral.empty': 'No discount codes generated yet this month.',
    'referral.generated': 'Discount codes generated!',
    'referral.generateFailed': 'Failed to generate codes',
    'referral.limitReached': 'Monthly limit reached',
    'referral.limitReachedDesc': 'You can create {limit} codes per month.',
    'referral.copied': 'Code copied!',
    'referral.usedBadge': 'Used',
    'referral.hide': 'Hide code',
    'referral.reveal': 'Reveal code',
    'referral.footer': 'Each code gives 10% off on a paid submission. Codes expire at the end of the month. Not stackable.',
    ...
    // Spot Bidding Dialog
    'bidding.title': 'Skip the Waiting List',
    'bidding.desc': 'Choose your spot in the queue. Higher positions get reviewed first!',
    ...
    'bidding.outbidNotice': 'If someone outbids you, you\'ll receive an email notification with the option to bid again.',
    'bidding.invalidCode': 'Invalid code',
    'bidding.invalidCodeDesc': 'This discount code does not exist.',
    'bidding.codeUsed': 'Code already used',
    'bidding.codeUsedDesc': 'This discount code has already been redeemed.',
    'bidding.codeExpired': 'Code expired',
    'bidding.codeExpiredDesc': 'This discount code has expired.',
    'bidding.discountAppliedToast': '{percent}% discount applied!',
  ...
  de: {
    ...
    'howItWorks.noSignup': 'Drei Schritte. Keine Anmeldung nötig. Einfach deine Musik.',
    'howItWorks.step1.title': 'Link einfügen',
    'howItWorks.step1.fullTitle': 'Datei hochladen oder Link einfügen',
    'howItWorks.step1.desc': 'Füge einen Spotify-, SoundCloud- oder beliebigen Musiklink ein',
    'howItWorks.step1.fullDesc': 'Lade eine Datei bis zu 100 MB hoch oder füge einfach einen Link ein — Spotify, SoundCloud, YouTube, alles geht.',
    'howItWorks.step2.title': 'In Warteschlange',
    'howItWorks.step2.fullDesc': 'Dein Track landet in der Live-Warteschlange. Der Streamer spielt ihn im Stream.',
    'howItWorks.step2.desc': 'Kostenlos einreichen oder zahlen um vorzurücken',
    'howItWorks.step3.title': 'Feedback erhalten',
    'howItWorks.step3.fullTitle': 'Live bewertet werden',
    'howItWorks.step3.desc': 'Sieh zu, wie dein Song live im Stream gespielt wird',
    'howItWorks.step3.fullDesc': 'Schau in Echtzeit zu, wie der Streamer zuhört und Feedback gibt.',
    'howItWorks.tip.psst': 'Psst…',
    'howItWorks.tip.secret': 'willst du ein Geheimnis wissen?',
    'howItWorks.tip.boostTitle': 'Platzierung boosten',
    'howItWorks.tip.boostDesc': 'Zahle eine kleine Gebühr, um die Warteschlange zu überspringen und deinen Lieblings-Creator zu unterstützen!',
    ...
    // Pre-Stream Spots
    'spots.title': 'Pre-Stream VIP-Plätze',
    ...
    'submission.messageLabel': 'Bemerkungen',
    'submission.optional': 'optional',
    ...
    'dashboard.myPageSettings': 'Seiteneinstellungen',
    ...
    'topSongs.saveMessage': 'Speichern',
    'topSongs.tab': 'Top Songs',
    // Stream Embed
    'streamEmbed.title': 'Stream-Embed-Widget',
    ...
    'pageSettings.tab.profile': 'Profil',
    'pageSettings.tab.form': 'Formular',
    'pageSettings.tab.content': 'Inhalt',
    'pageSettings.tab.pricing': 'Preise',
    'pageSettings.tab.design': 'Design',
    'pageSettings.tab.language': 'Sprache',
    'pageSettings.tab.presets': 'Vorlagen',
    'pageSettings.tab.stream': 'Stream',
    'pageSettings.profile.title': 'Grundinformationen',
    'pageSettings.profile.desc': 'Deine öffentlichen Streamer-Profilinformationen.',
    'pageSettings.profile.displayName': 'Anzeigename',
    'pageSettings.profile.displayNamePlaceholder': 'Dein Streamer-Name',
    'pageSettings.profile.profileUrl': 'Profil-URL',
    'pageSettings.profile.bio': 'Bio',
    'pageSettings.profile.bioPlaceholder': 'Erzähl den Zuschauern etwas über dich...',
    'pageSettings.profile.images': 'Bilder',
    ...
    // Section Visibility
    'pageSettings.sectionVisibility.title': 'Bereichs-Sichtbarkeit',
    'pageSettings.sectionVisibility.desc': 'Wähle welche Bereiche auf deiner Einreichungsseite sichtbar sind.',
    'pageSettings.sectionVisibility.howItWorks': 'So geht\'s',
    'pageSettings.sectionVisibility.howItWorksDesc': 'Schritt-für-Schritt-Anleitung für Einreicher',
    'pageSettings.sectionVisibility.topSongs': 'Top Songs Podest',
    'pageSettings.sectionVisibility.topSongsDesc': 'Zeige deine Top 3 Lieblings-Einreichungen',
    'pageSettings.sectionVisibility.publicQueue': 'Öffentliche Warteliste',
    'pageSettings.sectionVisibility.publicQueueDesc': 'Zeige ausstehende Einreichungen öffentlich an',
    'pageSettings.sectionVisibility.streamEmbed': 'Stream-Einbettung',
    'pageSettings.sectionVisibility.streamEmbedDesc': 'Zeige deinen Live-Stream auf der Seite an',

    // Image Upload
    'imageUpload.avatar': 'Profilbild',
    'imageUpload.banner': 'Banner',
    'imageUpload.avatarHelp': 'Quadratisches Bild (max. 2 MB)',
    'imageUpload.bannerHelp': 'Breites Bild (max. 6 MB)',
    'imageUpload.upload': 'Hochladen',
    'imageUpload.remove': 'Entfernen',
    'imageUpload.uploaded': 'Bild hochgeladen',
    'imageUpload.uploadedDesc': 'Klicke auf Speichern um die Änderung zu übernehmen.',
    'imageUpload.failed': 'Upload fehlgeschlagen',
    'imageUpload.failedDesc': 'Bitte versuche es erneut.',
    'imageUpload.clickBanner': 'Klicke zum Hochladen des Banners',
    'imageUpload.uploading': 'Wird hochgeladen…',

    // Referral / Discount Codes
    'referral.title': 'Rabattcodes',
    'referral.thisMonth': 'Codes diesen Monat',
    'referral.available': 'verfügbar',
    'referral.used': 'eingelöst',
    'referral.generate': 'Generieren',
    'referral.generateCount': '{count} Codes generieren',
    'referral.empty': 'Noch keine Rabattcodes in diesem Monat generiert.',
    'referral.generated': 'Rabattcodes generiert!',
    'referral.generateFailed': 'Codes konnten nicht generiert werden',
    'referral.limitReached': 'Monatliches Limit erreicht',
    'referral.limitReachedDesc': 'Du kannst {limit} Codes pro Monat erstellen.',
    'referral.copied': 'Code kopiert!',
    'referral.usedBadge': 'Eingelöst',
    'referral.hide': 'Code verbergen',
    'referral.reveal': 'Code anzeigen',
    'referral.footer': 'Jeder Code gibt 10% Rabatt auf eine bezahlte Einreichung. Codes laufen am Monatsende ab. Nicht kombinierbar.',
    ...
    // Spot Bidding Dialog
    'bidding.title': 'Warteliste überspringen',
    'bidding.desc': 'Wähle deinen Platz in der Warteschlange. Höhere Positionen werden zuerst bewertet!',
    ...
    'bidding.outbidNotice': 'Wenn jemand dich überbietet, erhältst du eine E-Mail-Benachrichtigung mit der Option, erneut zu bieten.',
    'bidding.invalidCode': 'Ungültiger Code',
    'bidding.invalidCodeDesc': 'Dieser Rabattcode existiert nicht.',
    'bidding.codeUsed': 'Code bereits verwendet',
    'bidding.codeUsedDesc': 'Dieser Rabattcode wurde bereits eingelöst.',
    'bidding.codeExpired': 'Code abgelaufen',
    'bidding.codeExpiredDesc': 'Dieser Rabattcode ist abgelaufen.',
    'bidding.discountAppliedToast': '{percent}% Rabatt angewendet!',
